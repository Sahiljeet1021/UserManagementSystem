...
const AddUser = () => {
    ...
    {
        e.preventDefault();
        await axios.post("http://localhost:8082/users",user)
        navigate("/")
    }
    ...
    <div className='container'>
        <div className='row'>
            ...
            <div className="mb-3">
                ...
                <input type={"text"} className='form-control'placeholder='Enter your Email-address' name='email' value={email} onChange={onInputChange}></input>
            </div>
